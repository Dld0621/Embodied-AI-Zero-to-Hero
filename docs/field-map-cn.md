...
如需知识点级导航，请进入 [45 节点知识体系](knowledge-system/README_CN.md)。领域地图回答“有哪些能力”，知识图谱回答“先学什么、如何验收”，Pipeline 回答“能力如何组成可运行系统”。
...
如需完整的“问题 → 前置课程 → Pipeline → 交付物 → 指标 → 门槛”契约，请进入[七条科研路线](learning-paths/README_CN.md)。

| 目标 | 起点 | 下一步要证明 |
|---|---|---|
| 从零学习机器人智能 | [知识体系](knowledge-system/README_CN.md) → [中文基础路线](foundations/00-roadmap.md) | 解析前置、通过验收，再完成一条 smoke Pipeline 并保留产物。 |
