...
> **历史快照说明：**下方 hash 和“当前”均指本报告保存时。主代理随后修订了三个示例 README，最新变化见 [论文与示例修订](paper-and-example-revision.md)；全书补读现已完成，最新覆盖与开放项见 [总交接](content-audit-handoff.md)。不要把此处旧 hash 当作当前终稿复核证据。
